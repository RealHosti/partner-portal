...
const demoProfile: Profile = {
  ...
  employment_title: 'Partnership Manager',
  company_role: 'Marketing',
  department: 'Creator Relations',
  industry: 'Gaming & Streaming',
  country: 'Deutschland',
  city: 'Berlin',
  about: 'Lokaler App-Preview ohne Supabase-Verbindung.',
  contact_email: 'partner@example.com',
  mobile_phone: null,
  phone: null,
  company_website: 'https://realhosti.de',
  company_address: null,
  preferred_contact_method: 'email',
  social_links: {
    twitch: 'https://twitch.tv/realhosti',
    instagram: '',
    x: '',
    linkedin: '',
    youtube: '',
